...
export default function NavigationPanel() {
  ...
  return (
    <>
      <div className="absolute bottom-0 left-20 right-20 z-20">
        {/* Handle to collapse/expand */}
        <div
          className="w-full h-6 flex justify-center items-center cursor-pointer bg-white rounded-t-xl"
